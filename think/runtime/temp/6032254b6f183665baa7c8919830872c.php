<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\www\Tp_try\think\public/../application/admin\view\tags\add.html";i:1508071928;s:69:"F:\www\Tp_try\think\public/../application/admin\view\common\left.html";i:1508072151;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>我很棒棒~</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="tagname" placeholder="" name="tagname"  type="text">
                            </div>
                        </div>
